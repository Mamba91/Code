...
pdf_path = f'/Users/andrea/Library/Mobile Documents/com~apple~CloudDocs/Python/{pdf_file}.pdf'
...
with open(pdf_path, 'rb') as file:
    ...
    for page_num in range(len(pdfreader.pages)):
        ...
        mp3_file_path = f'/Users/andrea/Library/Mobile Documents/com~apple~CloudDocs/Python/{mp3_file}_page_{page_num + 1}.mp3'
        tts = gTTS(clean_text, lang='en', tld='us')
